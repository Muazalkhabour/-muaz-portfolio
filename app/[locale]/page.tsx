...
const highlights = [
  ["Define the execution model early", "The first step is to decide whether the project needs a full website, a landing page, or a broader structural revision."],
  ["Interface function drives treatment", "Technical and visual decisions are shaped by message clarity, usage flow, and the intended action path."],
  ["Bilingual structure inside one system", "Arabic and English versions are developed within one unified structure that preserves consistency in content, identity, and use flow."],
];
...
const footerNotes = [
  {
    ...
    value: "Current work scope includes business websites, landing pages, and digital interfaces built around clarity, structure, and performance.",
  },
  {
    label: "Work style",
    value: "A structured working method that combines interface discipline, functional consistency, and message clarity.",
  },
  {
...
const trustSignals = [
  {
    ...
    value: "From initial requirement reading to a publishable interface inside a structured delivery path.",
  },
  {
    label: "Project focus",
    value: "Business websites, landing pages, and digital interfaces built on clear structure rather than surface styling alone.",
  },
  {
    label: "Decision filter",
    value: "How clearly the site explains value and directs the user toward the intended action path.",
  },
];
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = "Muaz Alshmoty | Web Developer for Structured Digital Experiences";
  const description =
    "Personal portfolio of Muaz Alshmoty covering web development, landing pages, interface engineering, and objective-led digital presence work.";
  ...
  return (
    <main dir="ltr" className="relative overflow-hidden">
      ...
      <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-6 sm:px-6 sm:py-8 lg:px-10">
        ...
        <div className="flex items-center gap-3">
          <nav className="hidden items-center gap-4 rounded-full border border-white/10 bg-white/5 px-4 py-2.5 text-xs text-white/70 backdrop-blur md:flex lg:gap-6 lg:px-5 lg:py-3 lg:text-sm">
            ...
            <Link href="/en/approach" className="transition hover:text-amber-200">Approach</Link>
            <Link href="/en/projects" className="transition hover:text-amber-200">Projects</Link>
            <Link href="/en/faq" className="transition hover:text-amber-200">FAQ</Link>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 pb-2 sm:px-6 md:hidden">
        <MobileHeaderNav links={mobileNavLinks} direction="ltr" />
      </div>
      ...
      >
        <div className="order-2 space-y-6 sm:space-y-8 lg:order-1">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <h1 className="flex max-w-4xl flex-col gap-2 text-[1.9rem] font-semibold leading-[1.35] tracking-tight text-white sm:text-[2.35rem] lg:text-[3rem]">
              ...
              <span className="block leading-[1.55] sm:leading-[1.5] lg:leading-[1.45]">
                I build digital structures that combine interface engineering, content clarity, and a more explicit decision path.
              </span>
            </h1>
            <p className="max-w-3xl text-[15px] leading-7 text-white/70 sm:text-lg sm:leading-8 lg:text-xl">
              My work combines web development, information structure, and interface clarity so the site operates as a presentation, communication, and decision layer rather than a visual shell alone.
            </p>
          </div>
          ...
          <p className="text-sm leading-7 text-white/55">
            The initial exchange is intended to determine the right execution model: a full website, a landing page, or a broader structural revision before treatment begins.
          </p>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-6 pt-6 sm:px-6 sm:pt-8 lg:px-10">
        <div className="mb-6 max-w-3xl rounded-[1.75rem] border border-cyan-200/12 bg-[linear-gradient(180deg,rgba(56,189,248,0.08),rgba(255,255,255,0.03)_34%,rgba(2,6,23,0.46)_100%)] p-5 shadow-[0_18px_45px_rgba(8,47,73,0.16)] sm:rounded-none sm:border-0 sm:bg-none sm:p-0 sm:shadow-none">
          ...
          <p className="max-w-3xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8">
            This section gives a first reading of the main execution paths, while the dedicated services page explains scope, requirements, and fit criteria in full.
          </p>
        </div>
      ...
      <section id="projects" className="mx-auto w-full max-w-7xl px-4 pb-16 pt-6 sm:px-6 sm:pt-8 lg:px-10">
        <div className="mb-8 max-w-3xl rounded-[1.75rem] border border-amber-200/14 bg-[linear-gradient(180deg,rgba(251,191,36,0.08),rgba(255,255,255,0.03)_34%,rgba(2,6,23,0.44)_100%)] p-5 shadow-[0_18px_45px_rgba(77,52,10,0.16)] sm:rounded-none sm:border-0 sm:bg-none sm:p-0 sm:shadow-none">
          ...
          <p className="max-w-3xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8">
            This section presents one representative case in condensed form to show treatment logic, interface structure, and execution direction, while the full reading remains on the projects page.
          </p>
        </div>
      ...
      <section id="contact" className="mx-auto w-full max-w-7xl px-4 pb-20 pt-4 sm:px-6 lg:px-10">
        <div className="rounded-[2rem] border border-rose-200/12 bg-[linear-gradient(180deg,rgba(244,114,182,0.08),rgba(255,255,255,0.03)_22%,rgba(15,23,42,0.76)_100%)] p-6 shadow-[0_22px_70px_rgba(2,6,23,0.18)] backdrop-blur-xl sm:p-10">
          ...
          <p className="max-w-3xl text-base leading-7 text-white/70 sm:text-lg sm:leading-8">
            The contact page serves as the formal intake point for new work, using a structured form to define scope, primary objective, and operating requirements before technical review begins.
          </p>
          <div className="mt-8 rounded-[1.85rem] border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(15,23,42,0.72))] p-5 shadow-[0_22px_70px_rgba(2,6,23,0.18)] backdrop-blur-xl sm:p-8">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-white/68 sm:text-base">
              The page includes a structured intake form for collecting core requirements, then prepares the request in an initial draft suitable for executive review.
            </p>
            <div className="mt-6">
              <Link
                href="/en/contact"
