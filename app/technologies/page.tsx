...
export const metadata: Metadata = {
  ...
  description: "صفحة التقنيات المعتمدة في تطوير الواجهات والمنتجات الرقمية، إلى جانب القنوات المرتبطة بالحضور الرقمي ودعم الوصول.",
  alternates: {
  ...
  openGraph: {
    title: "التقنيات | MUAZ TECH",
    description: "الأدوات التقنية والبنية العملية المعتمدة في بناء المواقع والواجهات والمنظومات الرقمية الداعمة للحضور الرقمي.",
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-4 sm:px-6 lg:px-10">
        <div className="rounded-[2rem] border border-amber-200/15 bg-gradient-to-br from-amber-200/10 to-white/5 p-6 backdrop-blur-xl sm:p-8">
          <div className="mb-6 max-w-3xl">
            ...
            <h2 className="text-2xl font-semibold text-white sm:text-3xl">القنوات الداعمة للحضور الرقمي</h2>
            <p className="mt-4 text-base leading-7 text-white/70 sm:text-lg sm:leading-8">لا يُنظر إلى الموقع هنا بوصفه عنصرًا منفصلًا، بل كجزء من منظومة تشمل الرسالة والمنصات والإعلانات عند الحاجة.</p>
          </div>
